...
def train_transformer_mpra():
    ...
    mlflow.set_experiment(
        "chromatin_accessibility_hybridCNNtransformer"
    )
    ...
    with mlflow.start_run():
        ...
        for epoch in range(epochs):
            ...
            if pearson_corr > best_pearson:
                ...
                torch.save(
                    model.state_dict(),
                    "models/best_CNNtransformer_mpra_model.pth"
                )
        ...
        plt.savefig(
            "./figures/CNNtransformer_mpra_regression_scatter.png"
        )

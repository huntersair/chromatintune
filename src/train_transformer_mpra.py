...
from src.model import SequenceTransformer
from src.transformer_dataset import TransformerMPRADataset

def train_transformer_mpra():

    mlflow.set_experiment(
        "chromatin_accessibility_transformer"
    )
    ...
    with mlflow.start_run():
        ...
        for epoch in range(epochs):
            ...
            if pearson_corr > best_pearson:
                ...
                torch.save(
                    model.state_dict(),
                    "models/best_transformer_mpra_model.pth"
                )
        ...
        plt.savefig(
            "./figures/transformermpra_regression_scatter.png"
        )
